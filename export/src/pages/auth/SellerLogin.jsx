...
import {
  ...
  CheckCircle,
  AlertCircle,
  Package, // Representing a seller's login, like a package or store
  ArrowRight,
...
const SellerLogin = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      const loginData = {
        ...
        role: "seller", // Role set to seller
      };
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:3000/api/auth/send-password-reset-otp", {
        ...
        body: JSON.stringify({ email: formData.email.toLowerCase().trim(), role: "seller" }), // Role set to seller
      });
      const data = await response.json();
      ...
      case 'login':
        return (
            <form onSubmit={handleLoginSubmit} className="space-y-6">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-lime-700"> {/* Green gradient */}
                Sign In to FreshMarket Seller
              </span>
              </h1>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 group-focus-within:text-green-600 transition-colors duration-200" /> {/* Green focus */}
                  <input
                      id="email"
                      type="email"
                      placeholder="Email"
                      ...
                      className={`w-full pl-12 pr-4 py-3.5 rounded-full border border-gray-300 dark:border-gray-600 transition-all duration-300 focus:outline-none focus:ring-1 focus:ring-green-200 text-gray-800 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 bg-gray-100 dark:bg-gray-700 hover:border-green-400 dark:hover:border-green-500
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <KeyRound className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 group-focus-within:text-green-600 transition-colors duration-200" /> {/* Green focus */}
                  <input
                      id="password"
                      ...
                      className={`w-full pl-12 pr-12 py-3.5 rounded-full border border-gray-300 dark:border-gray-600 transition-all duration-300 focus:outline-none focus:ring-1 focus:ring-green-200 text-gray-800 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 bg-gray-100 dark:bg-gray-700 hover:border-green-400 dark:hover:border-green-500
              ...
              <div className="flex justify-end items-center text-sm mt-4">
                <button
                    ...
                    className="text-green-600 dark:text-green-400 hover:text-green-800 dark:hover:text-green-300 font-medium transition-colors duration-200"
                >
                  Forgot Password?
                </button>
              </div>
              ...
              <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-4 mt-6 bg-gradient-to-r from-green-600 via-emerald-600 to-lime-700 text-white font-bold text-lg rounded-xl shadow-xl hover:shadow-2xl hover:from-lime-700 hover:to-green-600 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center space-x-2 animate-button-pop"
              >
                {isLoading ? (
                    <>
  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-white to-green-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4 sm:p-6 lg:p-8 font-inter overflow-hidden relative transition-colors duration-300">
        {/* Subtle Full-page Background */}
        <div className="absolute inset-0 z-0 bg-gradient-to-br from-white to-green-100 dark:from-gray-950 dark:to-gray-850 opacity-90 transition-colors duration-300"></div>
        ...
        <div className="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden my-8 flex flex-col md:flex-row z-10 transition-colors duration-300">
          ...
          {/* Left Half: Branding and Welcome - Green Theme */}
          <div className="md:w-1/2 p-8 flex flex-col items-center justify-center bg-gradient-to-br from-green-700 to-emerald-800 text-white text-center
          rounded-l-3xl rounded-r-none md:rounded-r-none rounded-b-3xl md:rounded-b-none relative overflow-hidden">
            ...
            <div className="w-28 h-28 bg-white/20 rounded-full flex items-center justify-center mb-6 shadow-xl animate-scale-in-subtle z-10">
              <Package className="w-16 h-16 text-white transform rotate-6" /> {/* Package icon for seller */}
            </div>
            <h2 className="text-4xl font-extrabold mb-4 text-shadow-lg animate-fade-in-up z-10">
              Welcome to <br />FreshMarket Seller
            </h2>
            ...
            {/* Buttons container for Home and Sign Up - below the paragraph */}
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 w-full max-w-sm justify-center items-center z-10 mt-6">
              <button
                  onClick={() => navigate("/")}
                  className="w-full sm:w-auto py-3.5 px-6 border-2 border-white text-white font-bold text-lg rounded-full shadow-lg hover:shadow-xl hover:bg-white hover:text-green-700 transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center space-x-2 group"
              >
