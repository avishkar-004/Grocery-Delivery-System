...
const Hero = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const response = await fetch('http://localhost:3000/api/landing/stat');
        if (!response.ok) {
        ...
        if (data.success) {
          setStatsData({
            total_users: formatNumber(data.data.totalBuyers),
            total_sellers: formatNumber(data.data.totalSellers),
            total_products: formatNumber(data.data.totalProducts)
          });
        } else {
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 py-12">
          <div className="text-center mb-16 pt-8">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 leading-tight tracking-tight">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600">Fresh</span>
          ...
          <div className="text-center bg-gradient-to-r from-emerald-500 via-blue-600 to-purple-600 rounded-3xl p-10 text-white shadow-2xl max-w-4xl mx-auto backdrop-blur-sm">
            ...
            <p className="text-lg mb-8 opacity-90 leading-relaxed max-w-2xl mx-auto">
              Join thousands of satisfied customers and sellers in the future of grocery shopping
            </p>
