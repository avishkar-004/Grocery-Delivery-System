        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="text-center bg-gradient-to-r from-emerald-500 via-blue-600 to-purple-600 rounded-3xl p-10 text-white shadow-2xl max-w-4xl mx-auto backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto">
              <button className="flex-1 bg-white text-emerald-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center space-x-2">
                <span>Get Started Now</span>
                <ArrowRight className="w-5 h-5" />
              </button>
              <button className="flex-1 border-2 border-white text-white hover:bg-white hover:text-emerald-600 font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105">
                Learn More
              </button>
            </div>
          </div>
